...
const config: Config = {
  ...
  // cacheDirectory: "/private/var/folders/ts/3q8xm9610_v8wy5f2p2ls2j00000gn/T/jest_dx",
  ...
  transform: {
    ...
    "<rootDir>/client/node_modules/(react-dnd|dnd-core|react-dnd-html5-backend)/dist/(.+).js": "ts-jest",
    "<rootDir>/client/node_modules/@react-dnd/(invariant|asap|shallowequal)?/dist/(.+).js": "ts-jest",
  },
  ...
  transformIgnorePatterns: [
    ...
    "<rootDir>/client/node_modules/(?!@react-dnd|react-dnd|core-dnd|dnd-core|react-dnd-html5-backend)/"
  ],
